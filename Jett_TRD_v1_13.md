# Jett TRD v1.13 - Account Management
...
**Portal URL**: `https://billing.stripe.com/p/login/test_00g8z7erM5kL9zy288`

Note: This is a test portal. For production:
1. Go to Stripe Dashboard → Settings → Billing → Customer Portal
2. Configure portal features (cancel, update payment, etc.)
3. Get the production portal URL
...
### Stripe Customer Portal (Sandbox)
- **Portal URL**: `https://billing.stripe.com/p/login/test_00g8z7erM5kL9zy288`
...
3. ⬜ Test on clean machine (verify Electron build works)
4. ⬜ Test Windows build (if targeting Windows users)
